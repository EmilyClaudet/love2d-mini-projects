function load_paddle1()
	...
	paddle1_speed = 400
	paddle1_sound = love.audio.newSource("res/paddle.wav")
end

function load_paddle2()
	paddle2_w = 20
	paddle2_h = 70
	paddle2_x = screen_width - paddle2_w - 5
	paddle2_y = (screen_height / 2 ) - (paddle2_h / 2)
	paddle2_speed = 400
	paddle2_sound = love.audio.newSource("res/paddle.wav")
end
...
function draw_paddle1()
	love.graphics.setColor(210, 26, 56)
